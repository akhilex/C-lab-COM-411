...
class Course
{
    ...
    for (int i = 0; i < courses.size(); i++) {           //modifying the details by entering roll number
     ...
     void displaycourse(vector<Course>& courses)    //Member function to display all student details
        {
            cout << "Course Credit\t \tCourse Name\t\n";
...
void deletecourse(vector<Course>&courses) {
    ...
    cin>> deleteCourseID;
    for (int i=0;i <courses.size(); i++) {
            if (deleteCourseID==courses[i].cid){
...
void searchCourse(vector<Course>& courses) {
  int searchCourseID;
    ...
    cin >> searchCourseID;
    for (int i = 0; i < courses.size(); i++) {
        if (courses[i].cid == searchCourseID) {
            cout << "Course ID: " << courses[i].cid<< endl;
            cout << "Course Name: " << courses[i].name1 << endl;
...
cout<<"\n___________________________________________________"<<endl;
  cout << "1. Add student" << endl;
        ...
        cout << "10.To delete course "<<endl;
        cout << "11.Search course"<<endl;
        cout << "12.EXIT";
        cout << "\n Enter your choice: ";
        cin >> choice;
        switch(choice) {
